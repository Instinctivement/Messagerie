<div class="chat-area">
             ...
             <div class="chat-area-footer">
              ...
              <input type="text" id="emoji" placeholder="Type something here..." />
              <svg xmlns="http://www.w3.org/2000/svg" id="emoji-btn" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-smile">
               <circle cx="12" cy="12" r="10" />
